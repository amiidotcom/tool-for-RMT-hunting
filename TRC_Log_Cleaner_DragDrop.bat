@echo off
REM TRC Log Cleaner - Drag & Drop Launcher
REM This batch file enables drag & drop functionality for trc_log_cleaner.py

echo TRC Log Cleaner - Drag ^& Drop Launcher
echo =====================================
echo.
